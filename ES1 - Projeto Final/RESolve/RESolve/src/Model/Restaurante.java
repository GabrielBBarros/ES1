...
public class Restaurante {
    public static void main(String[] args) {
        ...
        Ingrediente ingrediente4 = new Ingrediente("Calabresa", "Linguiça Calabresa", 500, "Gramas");
        ...
        estoque.addIngrediente(ingrediente4);

        // Criar itens especiais para bebida
        ItemEspecialBebida itemEspecial1 = new ItemEspecialBebida("Coca-Cola", "Lata de coca-cola 350ml", 1, "Lata 350ml");
        ItemEspecialBebida itemEspecial2 = new ItemEspecialBebida("Fanta", "Lata de fanta laranja 350ml", 2, "Lata 350ml");
        ...
        System.out.println("**************************************");
        cozinha.listarPratos();

        // Listar bebidas no bar
        System.out.println("--------------------------");
        bar.listarBebidas();
        System.out.println("**************************************");
        ...
        conta.setPaga(true);
        System.out.print(conta.estaPaga());
